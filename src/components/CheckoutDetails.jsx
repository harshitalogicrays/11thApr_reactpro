...
import { selectShippingAddress, store_shipping_address } from '../store/slices/checkoutSlice'
    ...
    <div className='row mt-5 p-3 shadow'>
        <div className='col-6'>
          ...
          <input
            ...
            required
            name="postal_code" class="mb-2 form-control"
          ...
          <input
            ...
            placeholder="Phone"
            required
            name="phone" class="mb-2 form-control"
